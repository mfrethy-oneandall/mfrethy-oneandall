...
|------|----|--------|--------------|
| forge | `100.97.220.115` | **PRIMARY** | MCP `:5100`, LM Studio `:1234`, OpenClaw `:18789`, LiteLLM `:5130` |
| sanctuary | `100.100.202.16` | Online — backup | Dev Hive `:5120`, Ollama `:11434` (`qwen3:14b`), Worker MCP `:5190` |
